...
public class AchievementsControllerTests {
	...
	@WithMockUser(value = "spring")
	@Test
	void testInitUnlockedForm() throws Exception {
		mockMvc.perform(get("/achievements/achievementsStatistics")).andExpect(status().isOk())
		.andExpect(view().name("achievements/achievementsStatistics"))
		.andReturn();
	}
